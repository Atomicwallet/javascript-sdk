...
function () {
  ...
  _createClass(LedgerApp, [{
    ...
    value: function () {
      var _publicKeySecp256k = _asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "_signSendChunk",
    value: function () {
      var _signSendChunk2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(chunkIdx, chunksCount, chunk) {
        var result, apduResponse, returnCode, statusCode, statusText, message, stack;
    ...
    key: "signSecp256k1",
    value: function () {
      var _signSecp256k = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(signBytes) {
        var hdPath,
            result,
            chunks,
            response,
    ...
    key: "showAddress",
    value: function () {
      var _showAddress = _asyncToGenerator(
      /*#__PURE__*/
